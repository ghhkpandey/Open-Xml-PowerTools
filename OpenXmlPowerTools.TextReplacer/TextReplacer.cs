...
{
    public static class WmlDocumentTextReplacerExtensions
    {
        public static WmlDocument SearchAndReplace(this WmlDocument doc, string search, string replace, bool matchCase)
        {
            return TextReplacer.SearchAndReplace(doc, search, replace, matchCase);
        }
    }

    public static class PmlDocumentTextReplacerExtensions
    {
        public static PmlDocument SearchAndReplace(this PmlDocument doc, string search, string replace, bool matchCase)
        {
            return TextReplacer.SearchAndReplace(doc, search, replace, matchCase);
        }
    }
