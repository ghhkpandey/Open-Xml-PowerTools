...
{
    public static class WmlDocumentReferenceAdderExtensions
    {
        public static WmlDocument AddToc(this WmlDocument doc, string xPath, string switches, string title, int? rightTabPos)
        {
            return (WmlDocument)ReferenceAdder.AddToc(doc, xPath, switches, title, rightTabPos);
        }
        public static WmlDocument AddTof(this WmlDocument doc, string xPath, string switches, int? rightTabPos)
        {
            return (WmlDocument)ReferenceAdder.AddTof(doc, xPath, switches, rightTabPos);
        }
        public static WmlDocument AddToa(this WmlDocument doc, string xPath, string switches, int? rightTabPos)
        {
            return (WmlDocument)ReferenceAdder.AddToa(doc, xPath, switches, rightTabPos);
        }
    }
