...
namespace OpenXmlPowerTools
{
    ...
    public static class WmlDocumentRevisionAccepterExtensions
    {
        public static WmlDocument AcceptRevisions(this WmlDocument document)
        {
            return RevisionAccepter.AcceptRevisions(document);
        }
        public static bool HasTrackedRevisions(this WmlDocument document)
        {
