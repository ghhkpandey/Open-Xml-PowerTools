...
{
    public static class SmlDocumentHtmlConverterExtensions
    {
        [SuppressMessage("ReSharper", "UnusedMember.Global")]
        public static XElement ConvertToHtml(this SmlDocument doc, SmlToHtmlConverterSettings htmlConverterSettings, string tableName)
        {
            return SmlToHtmlConverter.ConvertTableToHtml(doc, htmlConverterSettings, tableName);
        }

        [SuppressMessage("ReSharper", "UnusedMember.Global")]
        public static XElement ConvertTableToHtml(this SmlDocument doc, string tableName)
        {
            SmlToHtmlConverterSettings settings = new SmlToHtmlConverterSettings();
            return SmlToHtmlConverter.ConvertTableToHtml(doc, settings, tableName);
        }
    }
