...
{
    public static class WmlDocumentHtmlConverterExtensions
    {
        [SuppressMessage("ReSharper", "UnusedMember.Global")]
        public static XElement ConvertToHtml(this WmlDocument doc, WmlToHtmlConverterSettings htmlConverterSettings)
        {
            return WmlToHtmlConverter.ConvertToHtml(doc, htmlConverterSettings);
        }

        [SuppressMessage("ReSharper", "UnusedMember.Global")]
        public static XElement ConvertToHtml(this WmlDocument doc, HtmlConverterSettings htmlConverterSettings)
        {
